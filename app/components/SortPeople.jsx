...
const peopleOptions = [
  ...
  { value: '1', label: '1 Person', icon: <BsFillPersonFill size={20} /> },
  { value: '2', label: '2 People', icon: <HiUserGroup size={20} /> },
  { value: '3', label: '3 People', icon: <HiUserGroup size={20} /> },
  { value: '4', label: '4 People', icon: <FaUsers size={20} /> },
  { value: '5', label: 'More', icon: <FaUsers size={22} /> }
];
    ...
    <div className="flex items-center gap-2"> {/* Added wrapper div with flex */}
      <div className="relative inline-block w-[110px]"> {/* Fixed width container */}
        ...
        <button
          ...
          className="w-full flex items-center justify-between bg-white text-black px-2 py-1 border border-grey rounded-lg hover:bg-gray-100"
        >
