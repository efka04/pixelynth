...
Pixelynth visuals are free to use:
                        ...
                        <ul className="list-disc pl-6 space-y-3">
                            ...
                            <li>Compiling images from Unsplash to replicate a similar or competing service.</li>
                        </ul>
                        <div className="bg-blue-50 border-l-4 border-blue-400 p-4 mt-6">
                            <p className="text-sm text-blue-700">
                            Attribution isn’t mandatory, but it’s appreciated by Unsplash photographers as it helps showcase their work and motivates them to keep sharing.
                            </p>
                        </div>
                    </div>
                </div>
